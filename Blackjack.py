...
if P1 == "si":
    ...
    print("El blackjack es un juego para apostar en el cual el objetivo es mas puntos que la casa.")
    print("Estos puntos se obtienen con las cartas, las cuales inicialmente te dan 2 cartas")
    print("El valor de las cartas es igual al numero a escepcion de las que tienen letras")
